...
#define INACTIVITY_TIMEOUT        240       // Minutes of not driving until poweroff. it is not very precise.
...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PWM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define AUX_INPUT2            3, -1000, 0, 1000, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
    #define FLASH_WRITE_KEY       0x00  // Flash memory writing key. Change this key to ignore the input calibrations from the flash memory and use the ones in config.h
    ...
    #define PRI_INPUT1            2, 0, 2048, 4095, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            2, 0, 2048, 4095, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #endif
